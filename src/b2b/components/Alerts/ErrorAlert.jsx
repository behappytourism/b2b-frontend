...
function ErrorAlert() {
  ...
  return (
    <div
      className={`fixed  bottom-0 p-4 z-50 max-w-[55%] lg:max-w-[35%] transition-all duration-500  ${
        alertError?.status === true ? " right-0 " : " right-[-100vw] "
      }`}
    >
      <div className="w-full max-w-xl p-6 mt-auto ml-auto bg-white shadow-[0_4px_10px_7px_rgb(56_65_74_/_20%)] rounded-lg">
        <div className="flex items-start justify-between -mx-2">
          <div className="flex items-start px-2">
            <span className="flex-shrink-0 text-3xl text-red-600">
              <BiXCircle />
            </span>
            <div className="ml-2">
