...
function TransferHotelListComponent({
  hotel,
  stayIndex,
  hotelIndex,
  hotelLength,
            ...
            <div className="flex gap-2 w-full p-4 ">
              <div className="grid md:flex gap-2  items-center w-full">
                      ...
                      <div className="text-[13px] text-[#495057] font-[700] flex items-center gap-2">
                          ...
                          <span className="">
                            <p className="whitespace-nowrap">
                              {
                               hotel?.hotelId && hotel?.hotelId.length > 0 
                                ? "" : hotel.name + " " + hotel.terminalName ? hotel.name + " " + hotel.terminalName : hotel.name + " " 
                              }
                            </p>
                          </span>
                        </div>
                ...
                <div className="grid  md:flex md:min-w-[40%] md:max-w-[40%] w-[20%]  gap-2 items-center">
                  ...
                  <div className="left__section text-darktext space-y-2 ml-3">
                    <p className="text-[11px] font-semibold">To :</p>
                    <div className="flex flex-wrap items-center gap-1">
                      <h3 className="text-[15px] font-[650] text-[#495057]">
                        {resultArray[hotelIndex + 1]?.hotelId &&
                        resultArray[hotelIndex + 1]?.hotelId.length > 0
                          ...
                          <span className="">
                            <p className="whitespace-nowrap">
                              {resultArray[hotelIndex + 1]?.hotelData?.state
                                ?.stateName +
                                "," +
                                resultArray[hotelIndex + 1]?.hotelData?.country
                                  ?.countryName}
                            </p>
                          </span>
                        </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (
                        ...
                        onChangeHandler({
                          name:"transferToId",
                          name: resultArray[hotelIndex + 1].hotelId
                        })
                      }
                      if (
                        hotel?.hotelId &&
          ...
          {showTransfer && (
            <div className="bg-white  pb-6 first-letter:">
              {!error ? (
                      ...
                      <div className="grid md:grid-cols-3 p-2 gap-3 w-full">
                        {transfer?.length > 0 &&
                          transfer[stayIndex]?.stays[
                            ...
                            if (vehicle.hasOwnProperty("count") ) {
                              return (
                                <VehicleDropdown
                                  vehicle={vehicle}
                                  stayIndex={stayIndex}
                ...
                <div className="text-sm text-red-500 font-[500] tracking-wider flex justify-center items-center py-3 capitalize">
                  {error}
                </div>
              )}
            </div>
...
export default TransferHotelListComponent;
