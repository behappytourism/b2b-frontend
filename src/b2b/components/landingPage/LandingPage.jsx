              ...
              <div className="flex gap-10 justify-center pt-10">
                  ...
                  <div>
                    ...
                    <div className="max-w-lg text-gray-400 text-sm">
                      <h1>
                        ...
                        registered login credentials will be sent to the
                        registered email id wherein the agent can login and
                        access the services he wants to book.
                      </h1>
                    </div>
                  </div>
                </div>
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <div className="max-w-lg text-gray-400 text-sm">
                      <h1>
                        Reliability and safety of our customers’ personal data
                        are top of mind at Travellers Choice Tours, and that’s
                        why our sophisticated online portal is thoroughly
                        verified and secured by the most advanced digital
                        security certification authority – Thawte.
                      </h1>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="max-w-lg text-gray-400 text-sm">
                      <h1>
                        ...
                        offering instinctive and absolutely personalized
                        destination management services. But we don’t ask you to
                        take our words; know it for yourself by directly
                        visiting our Testimonials Page and see what our valuable
                        guests have to say about their experience of booking and
                        taking a tour or holiday with us.
                      </h1>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="max-w-lg text-gray-400 text-sm">
                      <h1>
                        ...
                        support center that is rapid to reply on every medium:
                        be it via Live Chat, WhatsApp. Whether you’ve any query
                        on our services or need assistance with the reservation
                        procedures or even looking for a little inspiration to
                        decide on your perfect holiday, get in touch with our
                        crew who will listen to all your travel needs anytime,
                        anywhere, and turn it into an absolute reality.
                      </h1>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex gap-20 justify-center pt-10">
                  ...
                  <div>
                    ...
                    <div className="max-w-lg text-gray-400 text-sm">
                      <h1>
                        ...
                        your payment information to protect you against fraud
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <div className="max-w-lg text-gray-400 text-sm">
                      <h1>
                        Travellers Choice Tours’ Best Price Guarantee promises
                        our esteemed clients that they will not only be
                        faultlessly served with the Destination Management
                        services of high-end quality, but also the best possible
