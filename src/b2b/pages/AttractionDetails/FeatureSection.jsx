...
function FeatureSection() {
  ...
  return (
    <div className="  border-gray-200 bg-light p-3  rounded-2xl md:my-4 lg:grid-cols-4 text-center justify-between w-full grid grid-cols-3 sm:grid-cols-4 gap-5">
      {agentExcursion?.availability && (
        <div className="text-center bg-soft lg:bg-light py-5 lg:py-0 rounded-lg lg:rounded-none md:flex gap-2">
          <span className="text-2xl lg:text-3xl text-black bg-slate-100  p-3 flex justify-center">
            <IoCalendarNumberSharp />{" "}
          </span>
          <span className="text-xs md:text-[13px] md:pt-3 max-w-xs text-text">
            {" "}
            Availibility:
            {/* {avail.length > 0 ? (
      ...
      {agentExcursion?.duration && (
        <div className="text-center bg-soft lg:bg-light py-5 lg:py-0 rounded-lg lg:rounded-none md:flex gap-2">
          ...
          <span className="text-[13px] pt-3 max-w-xs text-text ">
            Duration:{" "}
      ...
      <div className="text-center bg-soft lg:bg-light py-5 lg:py-0 rounded-lg lg:rounded-none md:flex gap-2">
        ...
        <span className="text-[13px] pt-3 max-w-xs text-text">Time slot: 8:00 - 11:30</span>
      </div>
      ...
      {agentExcursion?.bookingType === "ticket" && (
        <div className="text-center bg-soft lg:bg-light py-5 lg:py-0 rounded-lg lg:rounded-none md:flex gap-2">
          ...
          <span className="text-[13px] pt-3 max-w-xs text-text">Instant Confirmation</span>
        </div>
      )}
