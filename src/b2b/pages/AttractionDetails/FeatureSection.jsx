...
function FeatureSection() {
  ...
  return (
    <div className="  border-gray-200 bg-light py-4 lg:py-5 px-3 rounded-2xl md:my-4 lg:grid-cols-4 text-center justify-between w-full grid grid-cols-3 sm:grid-cols-4 gap-5">
