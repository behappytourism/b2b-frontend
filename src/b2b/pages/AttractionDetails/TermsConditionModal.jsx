...
function TermsConditionModal({setTermsModals, termsModals, data}) {
    console.log(termsModals, 'modal de');
    return (
       <div className='fixed hidden  md:flex justify-center items-center backdrop-blur-sm top-0 md:bottom-0 md:top-0 md:left-0 md:right-0 z-50 w-full md:p-4 md:overflow-x-hidden overflow-y-auto'>
        <div className='relative shadow-lg max-w-1xl bg-white  max-h-full h-96 w-[700px] rounded'>
