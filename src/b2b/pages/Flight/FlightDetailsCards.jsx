...
function FlightDetailsCards({
  ...
  return (
    <div
      className="grid grid-cols-12 place-items-center cursor-default mb-8 mt-1"
      data-te-target="#rightTopModal"
    >
      <div className="col-span-2">
        <div className="flex gap-2 items-center">
          <div className="">
            <img src={firstSegment?.airlineLogo} alt="" className="h-[35px]" />
          </div>
          <div className="">
      ...
      <div className="col-span-1 text-center">
        ...
        <p className="text-xs">
          {formatDateString(
            new Date(firstSegment?.departureDate).toISOString().split("T")
          )}
        </p>
      </div>
      <div className="col-span-2">
      ...
      <div className="col-span-1 text-center">
        ...
        <p className="text-xs">
          {formatDateString(
            new Date(firstSegment?.arrivalDate).toISOString().split("T")
          )}
        </p>
        {/* )} */}
      </div>
      ...
      <div className="absolute right-2 top-1">
            <button
              className=" text-[12px] text-orange-600 hover:text-darktext"
              onClick={() => handleModal()}
            >
              flight details
            </button>
