...
function ClientTransferMarkupModal({setMarkup,markupData, setMarkupData, vehicle, transferId, setShowVehicles}) {
    ...
    const submitHandler = async (e)=>{
        try {
            e.preventDefault()
            setIsLoading(true)
            const res = await axios.post(`/b2b/transfer/client/markup/update-single-transfer-profile`, {
...
export default ClientTransferMarkupModal
