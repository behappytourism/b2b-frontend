        ...
        <table className="w-full border rounded border-gray-100 shadow">
          <thead className="bg-stone-200 rounded">
            <tr className="w-full">
              ...
              {/* <th className="p-3 text-left">Adult Cost</th>
              <th className="p-3 text-left">Child Cost</th>
              <th className="p-3 text-left">Infant Cost</th>
              <th className="p-3 text-left">Agent Markup</th> */}
