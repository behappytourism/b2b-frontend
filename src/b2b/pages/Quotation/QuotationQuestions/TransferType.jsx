...
function TransferType({ data, tp, index }) {
  ...
  const { noOfAdults, noOfChildren, excursionFiltered, checkInDate } = useSelector(
              ...
              <div className="flex gap-2">
                {tp?.ticketSharedPricing === true ? (
                  <>
                    <input
                      type="radio"
                    // defaultChecked={tp?.selectedExcursionType === "Shared"}
                      id={"radio-default-2"}
                ...
                {tp?.ticketVehicleType?.length > 0 ? (
                  <>
                    <input
                      type="radio"
                      // defaultChecked={tp?.selectedExcursionType === "Private"}
                      id="radio-default-1"
