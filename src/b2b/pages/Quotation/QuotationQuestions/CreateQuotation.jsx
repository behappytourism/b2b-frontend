...
import { setAlertSuccess, setAlertError } from "../../../../redux/slices/homeSlice";
import BtnLoader from "../../../components/BtnLoader";
import { handleClearAllStates, setQuotationCurrency } from "../../../../redux/slices/quotationSlice";
import moment from "moment";


function CreateQuotation({ setQuestions }) {
  ...
        )
    ...
    navigate("/quotation/view",{state: res?.data?.quotationNumber})
  ...
        )
    ...
    console.log(selectedExcursionIds);
 

  return (
    <div className="w-full h-auto bg-white shadow-lg p-4">
    {/* Arrival and Departure */}
    <div className="border-b border-t pb-5">
    ...
    <div className="bg-white p-4">
                ...
                {ele.hotels.map((dt, i) => {
                  return (
                    ...
                    >
                      ...
                      <p className="text-sm">Checkin Date: {dt?.checkInDate}</p>
                      <p className="text-sm">Checkout Date: {dt?.checkOutDate}</p>
                    </div>
                  );
                })}
              </div>
      ...
      {Object.keys(selectedVisaId)?.length !== 0 && !isVisaQuotaionsDisabled && (
       ...
       <div  className="flex justify-end items-center gap-3 mb-16 lg:mb-0">
             <div className="flex gap-2">
              <div>
