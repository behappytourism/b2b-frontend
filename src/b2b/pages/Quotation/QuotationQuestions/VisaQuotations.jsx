...
function VisaQuotations({ setQuestions, setSteps }) {
  const { selectedVisa } = useSelector((state) => state.quotation);
      ...
      <div>
        <div className="pb-5">
          <h3 className="text-md tracking-wide text-center text-stone-600 font-bold">
            {" "}
            Do your clients need Visa, please chose nationality and proceed
          </h3>
        </div>
      </div>
      <div className="grid md:flex md:gap-20 gap-1 justify-center">
        <div className="pt-5">
          <h1 className="text-lg font-bold text-gray-400 ">Nationality</h1>
        </div>
      <div className="">
                ...
                filteredData?.map((ele)=>{
                  return(
                    <>
                     ...
                     className="hover:bg-slate-200 p-2 border-b cursor-pointer">{ele?.nationality}</p>
                    </>
                  )
                })
              }
              ...
              <div
                onClick={() => {
                  handleVisaSelection(
                    ...
                    ele.visaName,
                    ele.processingTime,
                    ele.processingTimeFormat,
                    ele?.validity,
                    ele?.validityTimeFormat
                  );
                  setQuestions({
                ...
                className="bg-white max-w-md rounded  shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer p-5"
              >
                    <div className="lg:w-64 w-56 bg-white  p-6">
                <div className="text-center">
                    <img src="https://www.careinsurance.com/kitextproxy/cms-careinsurance-com/upload_master/surveys/upload/4ee74d4de3947863f0c79f85702840a7.png" alt="Visa Logo" className="w-32 mx-auto"/>
                </div>
                <div className="mt-6">
