...
function TravellingPartner({ setQuestions, setSteps }) {
            ...
            <div className=" mt-2 flex justify-between mb-14 md:mb-0">
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="text-xs font-semibold text-white bg-gradient-to-l from-blue-600 to-red-600 hover:from-red-600 hover:to-blue-600 px-4 h-8 rounded-sm shadow-mn"
                >
                  Next
                </button>
              </div>
...
export default TravellingPartner;
