...
import ExcSupplimentsEditSelectBtn from "./ExcSupplimentsEditSelectBtn";
import { useSelector } from "react-redux";
import { config } from "../../../../constants";

function EditExcSupplimentCards({
  ele,
  selectedData,
  setSelectedData,
  index,
  ...
  const { selectedExcursionTypeSuppliments, selectedExcSupplimentsIds } =
...
export default EditExcSupplimentCards;
