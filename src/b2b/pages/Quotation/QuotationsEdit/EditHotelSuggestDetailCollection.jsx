...
function EditHotelSuggestDetailCollection({ setQuotationEdit }) {
  ...
  const [fromDate, setFromDate] = useState(checkInDate.slice(0, 10));
  const [toDate, setToDate] = useState(checkOutDate.slice(0, 10));
  ...
  // }, [existCheckoutDate !== undefined, lastIndex > 0])
    ...
    <div className="max-w-screen-lg mx-auto h-full">
      <div classsName="">
        ...
        {Object.keys(selectedHotel).length !== 0 ? (
          <div className="flex justify-start ml-24 pt-5 p-2">
            <button
              onClick={() => {
                dispatch(
                  setHotelToStayArray({
...
export default EditHotelSuggestDetailCollection;
