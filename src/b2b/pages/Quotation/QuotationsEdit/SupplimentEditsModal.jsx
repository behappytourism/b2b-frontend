...
import EditSupplimentTransferType from "./EditSupplimentTransferType";
import { previewImage } from "../../../../static/imagesB2B";
import { config } from "../../../../constants";
import EditSideSuppTransferModal from "./EditSideSuppTransferModal";

function SupplimentEditsModal({ data, select, set }) {
  const { setModal } = data;
  ...
  const handleRemove = (item) => {
    const removedData = selectedExcSupplimentsIds.filter(
      (ele) => ele !== item
    );
    set(removedData);
  ...
  const selectedExcursionsSuppliment = selectedExcSupplimentsIds.filter(
    (exc) => exc.isSelected
  );
...
export default SupplimentEditsModal;
