...
import EditTransferHotelListComponent from "../../../components/Quotation/Transfer/EditTransferHotelListComponent";
import { TbPlayerTrackNextFilled } from "react-icons/tb";



function EditTransferHotel({setQuotationEdit}) {
      ...
      <div>
            ...
            {isArrivalAirportDisabled && !isDepartureAirportDisabled ? (
              <>
                {[...stay?.hotels, departureAirport]?.map(
                  (hotel, hotelIndex) => {
                    return (
                      <EditTransferHotelListComponent
                        key={hotelIndex}
        ...
        <div className="flex justify-end gap-2">
          ...
          <button
            ...
            className="relative bg-gradient-to-l from-blue-500 to-red-600 hover:from-red-600 hover:to-blue-400  rounded text-[14px] font-[600] text-white shadow-sm w-[130px] py-2"
          >
            Next
...
export default EditTransferHotel
