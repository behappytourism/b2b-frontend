...
function EditSuggestHotelList({ setQuotationEdit }) {
    ...
    if (stays?.length) {
      ...
      stays?.map((ele) => {
        if (ele?.hotels?.length) {
          ...
          setExistCheckoutDate(
            ele?.hotels[lastIndex]?.checkOutDate?.slice(0, 10)
          );
        }
      });
    }
                ...
                <div key={stayIndex} className="mt-5 p-5 bg-white shadow-round">
                  <div className="flex justify-between p-1 pb-2">
                    ...
                    <p
                      ...
                      className="text-xs rounded-sm text-red-500  "
                    >
                      {/* <AiOutlineClose /> */}
                    </p>
                  </div>
                      ...
                      >
                        ...
                        <div
                          onClick={() => {
                            ...
                            setQuotationEdit({
                              ...
                              suggestDetailCollectionEdit: true,
                        ...
                        <div className="p-2 text-center">
                          ...
                          <div className="p-2 text-left">
                          {
                            ...
                            {
                              hotel?.hotelData?.state?.stateName && hotel?.placeName && (
                            <div className="text-xs text-grayColor">
                              {hotel?.placeName +
                                " , " +
            ...
            {stays[lastIndex]?.hotels?.length || stays[0]?.hotels?.length ? (
              <div className="py-4 flex justify-end mr-4 md:mr-0">
                <button
                  ...
                  className="text-xs  text-white bg-gradient-to-l from-blue-600 to-red-600 hover:from-red-600 hover:to-blue-600 px-4 h-8 rounded-sm"
                >
                  Next
                </button>
              </div>
...
export default EditSuggestHotelList;
