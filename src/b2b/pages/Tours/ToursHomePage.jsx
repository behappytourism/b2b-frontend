  ...
  const fetchAllAttractions = async () => {
    try {
      ...
      const res = await axios.get(
        `/b2b/resellers/client/attraction/all?skip=${filters.skip}&limit=${filters.limit}`,
        {
      ...
      setFilters((prev) => {
        return {
          ...
          hasMore:
            res?.data?.attractions?.totalAttractions > attractions?.length,
        };
      });
    } catch (error) {
      setIsLoading(false);
                ...
                <p style={{ textAlign: "center" }}>
                  {!isLoading ? (
                    <p className="text-gray-400 text-sm font-light tracking-tight py-2">
                      Thank you for visiting BE Happy Travel & Tourism
                    </p>
                  ) : (
                    ""
                  )}
              ...
              <div className="grid md:grid-cols-4 sm:grid-cols-2 gap-3">
                {attractions?.map((ele, index) => {
                  return (
                    <div
                      key={ele?._id}
                      className="bg-slate-100 shadow-md border w-full h-[400px] cursor-pointer"
                      onClick={() => {
                    ...
                    >
                      <div className="relative w-full h-52 overflow-hidden">
                        ...
                        <div className="absolute top-0 right-0 flex">
                          ...
                          <div>
                            <h1 className=" bg-red-500  p-1 text-white text-center font-semibold text-sm">
                      ...
                      <div className="p-4">
                        <div className=" flex justify-center h-14">
                          <h1 className="text-lg font-extralight text-center max-w-2xl line-clamp-2">
                            {ele?.title}
                          </h1>
                        </div>
